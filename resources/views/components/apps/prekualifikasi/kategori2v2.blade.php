    ...
    <x-elements.tables.table :datatable="false">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <x-elements.forms.input :isgroup="true" label="" jenis="text" :nama="'tahun_2.2'.$n" placeholder=""  />
                </td>
                <td>
                    <x-elements.forms.input :isgroup="true" label="" jenis="text" :nama="'tahun_1.2'.$n" placeholder=""  />
                </td>
                <td>
                    <x-elements.forms.input :isgroup="true" label="" jenis="text" :nama="'tahun_0.2'.$n" placeholder=""  />
                </td>
                <td>
                    <x-elements.dropzone.v2 url="prekualifikasi/upload" urlhapus="prekualifikasi/hapusfile" :n="(int)('2'.$n)" :nama="'lampiran.2'.$n++" />
                </td>
            </tr>
            <tr>
                <td>2.1.1.b</td>
                ...
                <td>
                    <x-elements.forms.radio :nama="'jwb.2'.$n" label=" 8 Hr.Shifts" nilai="8 Hr.Shifts" />
                </td>
                <td>
                    <x-elements.forms.radio :nama="'jwb.2'.$n" label=" 12 Hr.Shifts" nilai="12 Hr.Shifts" />
                </td>
                <td>
                    <x-elements.forms.radio :nama="'jwb.2'.$n" label=" Other" nilai="Other" />
                </td>
                <td>
                    <x-elements.dropzone.v2 url="prekualifikasi/upload" urlhapus="prekualifikasi/hapusfile" :n="(int)('2'.$n)" :nama="'lampiran.2'.$n++" />
                </td>
            ...
            <tr>
                ...
                <td>
                    <x-elements.forms.radio :nama="'jwb.2'.$n" label=" Yes" nilai="1" />
                </td>
                <td>
                     <x-elements.forms.radio :nama="'jwb.2'.$n" label=" No" nilai="0" />
                </td>
                <td>
                                        <x-elements.dropzone.v2 url="prekualifikasi/upload" urlhapus="prekualifikasi/hapusfile" :n="(int)('2'.$n)" :nama="'lampiran.2'.$n++" />
                </td>
